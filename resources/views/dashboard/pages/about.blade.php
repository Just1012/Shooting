                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" name="main_title_ar"
                                                    value="{{ $about->main_title_ar ?? '' }}" placeholder="Main Title Ar"
                                        ...
                                        <div class="col-md-12">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" name="main_title_en"
                                                    value="{{ $about->main_title_en ?? '' }}" placeholder="Main Title En"
                                                    id="titleEnTextarea" required>
                                            </div>
                                        </div><!--end col-->
                                        ...
                                        <div class="col-md-12">
                                            <div class="mb-3">
                                                ...
                                                <textarea class="form-control" name="desc_1_ar" placeholder="Description 1 Ar" rows="4" id="myeditorinstance">{{ $about->desc_1_ar ?? '' }}</textarea>
                                            </div>
                                        </div><!--end col-->
                                        <div class="col-md-12">
                                            <div class="mb-3">
                                                <label for="titleEnTextarea" class="form-label">Description 2 En</label>
                                                <textarea class="form-control" name="desc_1_en" placeholder="Description 2 En" rows="4" id="myeditorinstance">{{ $about->desc_1_en ?? '' }}</textarea>
                                            </div>
                                        </div><!--end col-->
                                        ...
                                        <div class="col-md-12">
                                            <div class="mb-3">
                                                ...
                                                <textarea class="form-control" name="desc_2_ar" placeholder="Description 2 Ar" rows="4" id="myeditorinstance">{{ $about->desc_2_ar ?? '' }}</textarea>
                                            </div>
                                        </div><!--end col-->
                                        <div class="col-md-12">
                                            <div class="mb-3">
                                                <label for="titleEnTextarea" class="form-label">Description 2 En</label>
                                                <textarea class="form-control" name="desc_2_en" placeholder="Description 2 En" rows="4" id="myeditorinstance">{{ $about->desc_2_en ?? '' }}</textarea>
                                            </div>
                                        </div><!--end col-->
