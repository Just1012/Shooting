...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('services', function (Blueprint $table) {
            ...
            $table->string('sector_6_ar')->nullable();
            $table->string('sector_6_en')->nullable();
            $table->string('sector_7_ar')->nullable();
            $table->string('sector_7_en')->nullable();
            $table->string('sector_8_ar')->nullable();
            $table->string('sector_8_en')->nullable();
            $table->timestamps();
        });
    }
